      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-body w-full",
              className
            )}
            ref={ref}
            {...props}
...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative min-h-body w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-body w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex min-h-body flex-1 flex-col",
